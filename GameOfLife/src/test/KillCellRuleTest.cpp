...
public:
	...
	static Test *suite() {
		...
		suite->addTest(new TestCaller<KillCellRuleTest>("testKillCellWithInsufficientNeighbors", &KillCellRuleTest::testKillCellWithInsufficientNeighbors));
		suite->addTest(new TestCaller<KillCellRuleTest>("testKeepAliveCellWithSufficientNeighbors", &KillCellRuleTest::testKeepAliveCellWithSufficientNeighbors));
		return suite;
	}
