...
public:
	...
	static Test* suite() {
		...
		suite->addTest(new TestCaller<KeepCellAliveRuleTest>("testKeepCellAlive", &KeepCellAliveRuleTest::testKeepCellAlive));
		suite->addTest(new TestCaller<KeepCellAliveRuleTest>("testNoopWhenCellIsDead", &KeepCellAliveRuleTest::testNoopWhenCellIsDead));
		return suite;
	}
