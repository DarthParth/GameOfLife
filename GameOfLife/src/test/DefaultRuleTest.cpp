...
public:
	...
	virtual ~DummyRule() {}
	int getLiveNeighbors() { return _liveNeighbors; }
protected:
...
public:
	...
	static Test *suite() {
		...
		suite->addTest(new TestCaller<DefaultRuleTest>("testNeighborsForTopLeftCorner", &DefaultRuleTest::testNeighborsForTopLeftCorner));
		suite->addTest(new TestCaller<DefaultRuleTest>("testNeighborsForTopRightCorner", &DefaultRuleTest::testNeighborsForTopRightCorner));
		suite->addTest(new TestCaller<DefaultRuleTest>("testNeighborsForBottomLeftCorner", &DefaultRuleTest::testNeighborsForBottomLeftCorner));
		suite->addTest(new TestCaller<DefaultRuleTest>("testNeighborsForBottomRightCorner", &DefaultRuleTest::testNeighborsForBottomRightCorner));
		suite->addTest(new TestCaller<DefaultRuleTest>("testNeighborsForInternalCell", &DefaultRuleTest::testNeighborsForInternalCell));
		return suite;
	}
private:
	Grid *_grid;
