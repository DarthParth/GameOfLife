...
public:
	...
	static Test *suite() {
		...
		suite->addTest(new TestCaller<GridTest>("testGridReset", &GridTest::testGridReset));
		suite->addTest(new TestCaller<GridTest>("testIsCellValid", &GridTest::testIsCellValid));
		suite->addTest(new TestCaller<GridTest>("testGetValidCell", &GridTest::testGetValidCell));
		suite->addTest(new TestCaller<GridTest>("testGetInvalidCell", &GridTest::testGetInvalidCell));
		suite->addTest(new TestCaller<GridTest>("testInitializeWithInvalidSeed", &GridTest::testInitializeWithInvalidSeed));
		suite->addTest(new TestCaller<GridTest>("testInitializeWithValidSeed", &GridTest::testInitializeWithValidSeed));
		return suite;
	}
